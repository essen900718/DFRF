...
def config_parser():
    ...
    parser.add_argument("--N_rand", type=int, default=120,
                        help='batch size (number of random rays per gradient step)')# 850, 1024
    ...
    parser.add_argument("--N_iters", type=int, default=60000,
                        help='number of iterations') # 600000
    ...
    parser.add_argument("--i_weights", type=int, default=5000,
                        help='frequency of weight ckpt saving') # 5000
...
def train():
    ...
    if args.dataset_type == 'audface':
        if args.with_test == 1:
            ## render -> with_test == 1 ##
            # imgs,   poses, auds, bc_img, [H, W, focal, cx, cy], lip_rects,    torso_bcs, render_poses
